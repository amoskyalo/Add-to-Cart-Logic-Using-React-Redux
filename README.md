...
After reading about React Redux, I decided to test my understanding by building this simple project where you can add items to cart. You can check the live demo of the project [here](https://amoscart.netlify.app/). This is what I was able to implement in this project:
  - Add an item to cart. 
